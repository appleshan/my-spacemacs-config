...
values."
  ...
  (setq-default
   ...
   ;; to `emacs-version'.
   dotspacemacs-elpa-subdirectory "26.0.91"
   ...
   dotspacemacs-themes '(;; @see https://emacs-china.org/t/topic/4038/24
                         ;; doom 的优点: 只突出显示正文和代码，层次感很强，注意正文，代码块名字、begin line字体颜色依次变淡
                         doom-one
                         spacemacs-dark
                         spacemacs-light
                         zerodark)
