  ...
  (setq-default
   ...
   '(
     ...
     (auto-completion :variables
                      ...
                      :disabled-for erc git github markdown)
     ...
     plantuml ; uml
     (python :packages
             company eldoc flycheck helm-pydoc importmagic live-py-mode org pip-requirements pipenv py-isort ; pylookup
...
before packages are loaded."
  ...
  (setq socks-server '("SS server" "127.0.0.1" 18080 5))

  ;;{{ 解决 org 表格里面中英文对齐的问题
  ;; 可选字体组合及字体大小：
  ;; Hack | Source Han Sans CN  : [ 12 14 ], [ 14 16 ], [ 15 18 ]
